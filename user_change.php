...
<div class="container" style="margin-top:30px">                 
        <div class="row" >
			<div class="col-md-12">
				   <h2 class="page-header text-primary"> Dashboard <small> Welcome To Food World</small></h2>	
			</div>
			<div class="col-md-3">
				<?php
			...
			<div class="col-md-offset-1 col-md-6">
				 <?php 
								...
								{
									 $sql="select * from user_reg where UPASS='{$_POST["opass"]}' and UID='{$_SESSION["UID"]}'";
									 $result=$con->query($sql);
									 if($result->num_rows>0)
										{
											if($_POST["npass"]==$_POST["cpass"])
											{
												 $sql="UPDATE user_reg SET  UPASS='{$_POST["npass"]}' where  UID='{$_SESSION["UID"]}'";
												$con->query($sql);
